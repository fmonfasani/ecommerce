      ...
      if (isRegistered) {
        ...
        if (isLoggedIn) {
          ...
          setNotificationMessage(
            `Registro y login exitoso. Bienvenido/a ${userRegister.name}`
          );
          ...
          setGeneralError(
            "El registro fue exitoso, pero el inicio de sesión falló. Por favor, intenta nuevamente."
          );
        }
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            <div className="relative z-10 mt-0 bg-opacity-60 bg-white p-4 rounded-lg">
              ...
              <p className="max-w-xl text-sm text-gray-600 text-center">
                Regístrate hoy mismo, podrás acceder a promociones especiales y
                conocer las últimas novedades de nuestra tienda.
              </p>
            </div>
            <div
              className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-2 lg:gap-6"
              style={{ color: "#333" }}
            >
              ...
              <div className="md:col-span-1 lg:col-span-1">
                ...
                <select
                  ...
                  disabled={
                    ...
                    !isValidCountry(userRegister.country)
                  }
                >
                  <option value="">Selecciona una ciudad</option>
                  {isValidCountry(userRegister.country) &&
                    cities[userRegister.country]?.map((city) => (
            ...
            />
            <ButtonRedirectUser
              text="¿Ya posees una cuenta? Haz clic aquí para ingresar"
